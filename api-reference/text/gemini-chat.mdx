...
api: "POST https://zcbservice.aizfw.cn/kyyReactApiServer/v1/chat/completions"
---
...
<ParamField path="model" type="string" required>
  要使用的模型的 ID。Gemini 官方格式仅支持 Gemini 模型：
...
HttpRequest request = HttpRequest.newBuilder()
    .uri(URI.create("https://zcbservice.aizfw.cn/kyyReactApiServer/v1/chat/completions"))
    .header("Authorization", "Bearer {{YOUR_API_KEY}}")
    .header("Content-Type", "application/json")
...
response = requests.post(
    'https://zcbservice.aizfw.cn/kyyReactApiServer/v1/chat/completions',
    headers={
        'Authorization': 'Bearer {{YOUR_API_KEY}}',
