...
<ParamField path="resolution" type="string">
  ...
  <Warning>veo_3_1_fast_stable / veo_3_1_pro_stable 不支持 4K</Warning>
</ParamField>
...
<ParamField path="aspect_ratio" type="string">
  ...
  <Note>分辨率通过 resolution 字段单独指定，aspect_ratio 不支持 -1080p/-4K 后缀</Note>
</ParamField>
...
<ParamField path="input_reference" type="array">
  ...
  <Warning>veo_3_1_fast_stable 仅支持首尾帧模式，不支持参考图模式</Warning>
