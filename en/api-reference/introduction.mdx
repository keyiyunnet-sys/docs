...
<CardGroup cols={3}>
  ...
  <Card title="Image Generation API" icon="image" href="/en/api-reference/image/nano-banana-create">
    Support for Nano Banana image generation model, creating high-quality images from text prompts
  </Card>
  <Card title="Text Processing API" icon="message" href="/en/api-reference/text/llmpower-openai-chat">
    Support for LLM text APIs, providing intelligent conversation and text generation capabilities
  </Card>
</CardGroup>
