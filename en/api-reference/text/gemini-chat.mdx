...
<ResponseField name="data.usage.prompt_tokens" type="integer">
  Number of tokens used in the prompt
</ResponseField>

<ResponseField name="data.usage.completion_tokens" type="integer">
  Number of tokens used in the completion
</ResponseField>

<ResponseField name="data.usage.total_tokens" type="integer">
