...
- `grok_video3`: Variable duration from `6-30` seconds, supports `480p` / `720p`, billed per second
- `grok_video3_pro`: Fixed `10` second output and does not support manual resolution selection
- `grok_video3_max`: Supports `6 / 10 / 12 / 16 / 20 / 30` seconds, supports `480p` / `720p`, defaults to `9:16` + `720p`
...
<ParamField body="duration" type="integer">
  ...
  Rules:
  - `grok_video3`: supports `6-30`; default is `6`
...
<ParamField body="aspect_ratio" type="string">
  ...
  - `grok_video3_pro`: defaults to `9:16`
  - `grok_video3_max`: only supports `16:9`, `9:16`, `1:1`; default is `9:16`
</ParamField>
...
<ParamField body="resolution" type="string">
  ...
  Rules:
  - `grok_video3`: supports `480p` and `720p`; default is `480p`
  - `grok_video3_pro`: handled by default internal configuration
...
| Feature | grok_video3 | grok_video3_pro | grok_video3_max |
|---------|-------------|-----------------|-----------------|
| Duration | `6-30` seconds | Fixed `10` seconds | `6 / 10 / 12 / 16 / 20 / 30` seconds |
| Ratio | `16:9` / `9:16` / `1:1` / `3:2` / `2:3` | Default `9:16` | `16:9` / `9:16` / `1:1` |
| Quality | `480p` / `720p` | Default `720p` | `480p` / `720p` |
| Reference images | Up to `7` | Compatible with reference image input | Up to `5` public URLs |
...
4. More reference images usually mean longer queue and generation times.
</Info>
