---
title: "Seedance - Query Task"
description: "Query Seedance video generation task status and results"
...
| Service Tier | Price | Generation Time | Use Case |
|--------------|-------|-----------------|----------|
| default (online) | Standard price | Faster | Scenarios requiring quick generation |
| flex (offline) | 50% of standard price | Slower (about 2-3x time) | Batch generation not time-sensitive |
