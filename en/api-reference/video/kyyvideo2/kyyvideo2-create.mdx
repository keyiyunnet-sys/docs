...
<ParamField path="model" type="string" required>
  ...
  - `kyyvideo2` - Standard model (only supports generation with reference videos)
  - `kyyvideo2_fast` - Fast model (only supports generation with reference videos)
  - `kyyvideo2_pro` - Pro model (optional reference videos)
  - `kyyvideo2_fast_pro` - Fast Pro model (optional reference videos)
</ParamField>
...
|-------|------------------------|------------------|---------------|
| kyyvideo2 | ✅ Only with reference videos | Standard | Standard |
| kyyvideo2_fast | ✅ Only with reference videos | Fast | Standard |
| kyyvideo2_pro | ⭕ Optional reference videos | Standard | High Quality |
| kyyvideo2_fast_pro | ⭕ Optional reference videos | Fast | High Quality |
