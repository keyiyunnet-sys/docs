...
api: "GET https://api.globalaiopc.com/videos/{id}"
---
...
```bash cURL
curl --request GET \
  --url https://api.globalaiopc.com/videos/vgen_abc123def456 \
...
HttpRequest request = HttpRequest.newBuilder()
    .uri(URI.create("https://api.globalaiopc.com/videos/vgen_abc123def456"))
    .header("Authorization", "Bearer {{key}}")
    .GET()
    .build();
...
response = requests.get(
    'https://api.globalaiopc.com/videos/vgen_abc123def456',
