...
<ParamField path="id" type="string" required>
  ...
  <Note>The create API returns this value as `projectId`. Use that value as the `id` here.</Note>
</ParamField>
...
HttpRequest request = HttpRequest.newBuilder()
    .uri(URI.create("https://zcbservice.aizfw.cn/kyyReactApiServer/v1/result/proj_sd2manxue_1234567890"))
    .header("Authorization", "Bearer {{key}}")
    .GET()
    .build();
...
response = requests.get(
    "https://zcbservice.aizfw.cn/kyyReactApiServer/v1/result/proj_sd2manxue_1234567890",
