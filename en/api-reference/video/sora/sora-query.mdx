...
api: "GET https://zcbservice.aizfw.cn/kyyReactApiServer/v1/videos/{id}"
---
...
HttpRequest request = HttpRequest.newBuilder()
    .uri(URI.create("https://zcbservice.aizfw.cn/kyyReactApiServer/v1/videos/sora_abc123def456"))
    .header("Authorization", "Bearer {{key}}")
    .GET()
    .build();
...
response = requests.get(
    'https://zcbservice.aizfw.cn/kyyReactApiServer/v1/videos/sora_abc123def456',
