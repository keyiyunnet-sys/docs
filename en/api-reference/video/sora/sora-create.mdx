...
description: "Create video generation tasks using Sora models with support for 4, 8, and 12 second durations and multiple resolutions"
...
<CardGroup cols={2}>
  ...
  <Card title="openAiSora2Pro" icon="sparkles">
