...
HttpRequest request = HttpRequest.newBuilder()
    .uri(URI.create("https://zcbservice.aizfw.cn/kyyReactApiServer/v1/result/proj_1234567890"))
    .header("Authorization", "Bearer {{key}}")
    .GET()
    .build();
...
response = requests.get(
    "https://zcbservice.aizfw.cn/kyyReactApiServer/v1/result/proj_1234567890",
