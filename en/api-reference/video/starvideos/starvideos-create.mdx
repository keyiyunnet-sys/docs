...
api: "POST https://zcbservice.aizfw.cn/kyyReactApiServer/startVideo/v1/starvideos/videos"
---
...
curl --request POST \
  --url https://zcbservice.aizfw.cn/kyyReactApiServer/startVideo/v1/starvideos/videos \
