---
title: "StarVideos O3 - Query Task"
description: "Query the status and result of StarVideos O3 video generation tasks"
...
Use the task ID to query the status and result of a `StarVideos O3` video generation task.
...
<ResponseField name="model" type="string">
  Model name used for generation. Current value: `starvideos_o3`.
</ResponseField>
