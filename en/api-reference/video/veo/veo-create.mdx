...
<ParamField path="input_reference" type="array">
  ...
  <Warning>veo_3_1_fast_stable only supports first/last frame mode, does not support imgUrl reference image mode</Warning>
...
<ParamField path="first_image" type="string">
  ...
  - Used with `lastFrameUrl`: First/last frame mode
