...
<ParamField path="resolution" type="string">
  ...
  <Warning>veo_3_1_fast_stable / veo_3_1_pro_stable do not support 4K</Warning>
</ParamField>
...
<ParamField path="aspect_ratio" type="string">
  ...
  <Note>Resolution is specified separately via the resolution field, aspect_ratio does not support -1080p/-4K suffixes</Note>
</ParamField>
...
<ParamField path="input_reference" type="array">
  ...
  Cannot be used with first/last frame mode.
  ...
  <Warning>veo_3_1_fast_stable only supports first/last frame mode, does not support reference image mode</Warning>
...
<ParamField path="last_image" type="string">
  Last frame image URL, must be used with `first_image`
...
<CardGroup cols={2}>
  ...
  <Card title="Multiple Model Options" icon="sparkles">
    Provides fast_stable, pro_stable, fast, and pro models
  </Card>
